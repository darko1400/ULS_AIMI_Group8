...
class nnUNetTrainer_ULS_100_StrongElastic_nuno(nnUNetTrainer):
    ...
    def get_training_transforms(patch_size, rotation_for_DA, deep_supervision_scales,
        ...
        transforms.append(SpatialTransform(
            ...
            p_elastic_deform=0.4,
            elastic_deform_scale=(0.02, 0.25),
            elastic_deform_magnitude=(10.0, 40.0),
        ...
        print("StrongElastic transforms built successfully")
