...
from nnunetv2.training.data_augmentation.custom.random_lesion_morphology import RandomLesionMorphologyTransform
...
class nnUNetTrainer_ULS_100_Morph_aksha(nnUNetTrainer):
    ...
    def get_training_transforms(patch_size, rotation_for_DA, deep_supervision_scales,
        ...
        transforms.append(RandomLesionMorphologyTransform(lesion_label=1, p_per_sample=0.3, radius_range=(1, 3)))
        if do_dummy_2d_data_aug:
